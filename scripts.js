...
function buttonGame(playerSelection, computerSelection) {
  ...
  let historyWin = document.createTextNode(
    `You win - ${playerSelection} beats ${computerSelection}. `
  );
  let historyLose = document.createTextNode(
    `You lose - ${computerSelection} beats ${playerSelection}. `
  );
  let historyTie = document.createTextNode(
    `Tie - You both picked ${playerSelection}. `
  );
